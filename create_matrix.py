...
os.system('vap -c freq {0}/* | egrep "( {1}..| {2}..| {3}..)" > frequency_list.txt' .format(directory,rounding,rounding+1,rounding-1))

# CREATE AN ARRAY WHICH SEPARATES THE FILENAME AND THE FREQUENCY
y = np.genfromtxt("frequency_list.txt", dtype=[('filename','S40'),('freq','S40')])
